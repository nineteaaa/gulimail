...
public class PmsOssController {
    ...
    String accessId = "LTAIHzlEVnUrNGzG";      // 请填写您的AccessKeyId。
    String accessKey = "Rq2G6ASdoCvtlePfYG1XV4DSKxOUbD"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "gulimall190222";                    // 请填写您的 bucketname 。
